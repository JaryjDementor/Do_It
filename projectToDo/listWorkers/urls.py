...
from .viewses.views_workers_tasks import TaskList
from .viewses.views_team import list_workers, add_an_employee, delete_team
from .viewses.views_profile_user import profile_user, create_new_team, MyTasks
from .views import (
    # list_workers,
    # TaskList,
    TaskComplete,
