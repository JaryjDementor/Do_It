...
class ViewListWorkersTestCase(TestCase):
    def setUp(self):
        ...
        test_team_list = TeamsList.objects.create(name_team="TestTeam_1", id_admin="2")
        ...
        test_tasks_list = Employees_Task_List.objects.create(
            ...
            id_worker="1",
            id_team="1",
            description="Create new Django project.",
            status="Not complete",
            categories="django",
            date_of_completion="2022-06-23 00:00:00",
        )
    ...
    def test_list_workers(self):
        ...
        self.assertEqual(status.HTTP_200_OK, response.status_code)
        self.assertEqual(list(employees.values_list("username")), [("TestUser",)])
    ...
    def test_TaskList(self):
        ...
        response_post = c.post(
            "/tasks/1/1",
            {
                ...
                "categories": "Django",
                "date_of_completion": "2022-06-29 00:00:00",
            },
        )
        ...
        self.assertEqual(
            str(tasks_create),
            "<QuerySet [<Employees_Task_List:  Create task 2 Not complete Django 2022-06-29 00:00:00+00:00>]>",
        )
        self.assertEqual(status.HTTP_200_OK, response_post.status_code)
        self.assertEqual(
            str(tasks_employee),
            "<QuerySet [<Employees_Task_List:  Create new Django project. Not complete django 2022-06-23 00:00:00+00:00>, <Employees_Task_List:  Create task 2 Not complete Django 2022-06-29 00:00:00+00:00>]>",
        )
